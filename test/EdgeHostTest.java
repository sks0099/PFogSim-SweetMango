...
class EdgeHostTest {
    ...
    @Test
    @DisplayName("Get Set Location")
    void testGetSetPlace() {
        Location testLocation = new Location(1.0, -2.0, 100.0);
        Integer id = 456;
        RamProvisioner rp = new RamProvisioner(999) {
            @Override
        ...
        BwProvisioner bwp = new BwProvisioner(777) {
            @Override
            public boolean allocateBwForVm(Vm vm, long l) {
                return false;
            }
            ...
            @Override
            public boolean isSuitableForVm(Vm vm, long l) {
                return false;
            }
        };
        PeList pel = new PeList();
        //EdgeHost EH = new EdgeHost(id, rp, bwp, 655360000, );
