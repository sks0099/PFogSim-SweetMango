...
public class Parabola {
    ...
    public static Parabola getLeftChild(Parabola p) {
        ...
        while(child.type == IS_VERTEX) child = child.child_right; //Commented by sks0099 on 20250125
        //while(child.type == IS_VERTEX) child = child.child_left; // Added by sks0099 on 20250125
        return child;
    }
    ...
    public static Parabola getRightChild(Parabola p) {
        ...
        while(child.type == IS_VERTEX) child = child.child_left; //Commented by sks0099 on 20250125
        //while(child.type == IS_VERTEX) child = child.child_right; // Added by sks0099 on 20250125
        return child;
    }
