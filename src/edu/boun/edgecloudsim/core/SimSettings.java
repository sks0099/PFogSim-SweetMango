...
public class SimSettings {
    ...
    public boolean initialize(String propertiesFile, String edgeDevicesFile, String applicationsFile, String linksFile) {
        ...
        try {
            ...
            generatMobileDeviceFogNodePlot = Boolean.parseBoolean(prop.getProperty("generate_json_for_mobile_device_fog_node_plot"));
    ...
    public boolean getGeneratMobileDeviceFogNodePlot() {
        return this.generatMobileDeviceFogNodePlot;
    }
}